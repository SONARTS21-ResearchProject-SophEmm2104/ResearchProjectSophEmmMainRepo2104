...
*As a candidate tool we propose SuperCollider IDE. With the use of SuperCollider one can synthesize one's sounds from scratch, an oppurtunity which is not applicable to many DAWs. Moreover, a music teacher can use this enviroment in order to explain the sound parameters to his/her music student e.g. harmonics. Furthermore, in an more advanced level a music teacher can teach students the process of making their own sound interactive systems by connecting their created sounds to sensors.*  
...
<u>Some benefits of the use of Music Programming in music education are listed to the list below:</u>
