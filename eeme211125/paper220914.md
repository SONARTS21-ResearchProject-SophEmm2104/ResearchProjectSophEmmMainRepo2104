...
*As a candidate tool we propose SuperCollider IDE. With the use of SuperCollider one can synthesize one's sounds from scratch, an oppurtunity which is not applicable to many DAWs. Moreover, a music teacher can use this enviroment in order to explain the sound parameters to his/her music student e.g. harmonics. Furthermore, in an more advanced level a music teacher can teach students the process of making their own interactive sound systems by connecting their created sounds to sensors.*
...
<u> Benefits of Music Programming in Music Composition and Performance </u>
...
- Experimentation and Improvisation with sound itslef
...
Although SuperCollider can give us many oppotunities and aspects of what music is and what music can be, there are some problematics that if not surpassed it may be difficult to comprehend.
...
In spite the fact that all the above metion difficulties can be also cosidered as prerequisites in order for one to use SuperCollider, when one posses a laptop and/or PC and is willing to overcome partially some of these difficulties e.g. one's elementary level of English, a new whole world of potentials is unlocked. The above mentioned problematics can be also considered as difficulties of our nowadays society. In order for one to be up to date with the existing trends in music and education one should strongly consider overcoming these above mentioned aspects.

# what is the context of music education?

The curriculum of Music Education nowadays still focuses only on advancing on an music instrument and/or music theory. Despite the fact that technology is a part of our everyday life
...
Music School "Mousiko Karavi" (Oraiokastron/Thessaloniki, Greece) in
