...
# What is the context of Μusic Εducation nowadays
...
# The parameters and conditions of Μusic Εducation with Τechnology today
...
- Knowledge of Programming *παραδείγματα, ξεκινάω από αυτό*
- Acoustics of sound
...
*το παρόν άρθρο διατείνεται πως το σουπερκολιντερ είναι καλό εργαλείο γι' αυτό τον σκοπό*
...
*να κάνω συνδέσεις με προηγούμενα κεφάλαια*
...
*As a candidate tool we propose SuperCollider IDE. With the use of SuperCollider one can synthesize one's sounds from scratch, an opportunity which is not applicable to many DAWs. Moreover, a music teacher can use this environment in order to explain the sound parameters to his/her music student e.g. harmonics. Furthermore, in an more advanced level a music teacher can teach students the process of making their own interactive sound systems by connecting their created sounds to sensors. Needless to say that the involvement with programming can be beneficial for learning other subjects too such as coding, English language, mathematics and Physics.*



# Benefits and advantages of SuperCollider as a tool for music education

*πως ανταποκρίνεται το SuperCollider στα ερωτήματα που έχω θέσει ως προς την εκπαίδευση*

*μετανομασία κεφαλαίου και διαμόρφωση περιεχομένου*
...
<u> Benefits of the use of SuperCollider in Music Education </u>

1. Use of SuperCollider in order to explain sound parameters e.q. harmonics
2. Processing of audio files in SuperCollider
3. Sound synthesis/creation of SynthDefs
4. Creation of Interactive Sound Systems
5. Connection of various Sensors and other hardware
6. Processing analysis mindset
7. Data processing
...
In spite the fact that all the above mention difficulties can be also considered as prerequisites in order for one to use SuperCollider, when one posses a laptop and/or PC and is willing to overcome partially some of these difficulties e.g. one's elementary level of English, a new whole world of potentials is unlocked. The above mentioned problematics can be also considered as difficulties of our nowadays society. In order for one to be up to date with the existing trends in music and education one should strongly consider overcoming these above mentioned problems.
