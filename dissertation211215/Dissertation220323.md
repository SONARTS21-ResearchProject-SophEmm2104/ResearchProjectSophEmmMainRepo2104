...
Για την επιτελέση (performance) αυτής της παρτιτούρας επιτρέπονται όλα τα αντικείμενα τα οποία έχουν ως βάση σύνθεσης το πλαστικό. Τα αντικείμενα αυτά χρησιμοποιούνται στο έργο ως μουσικά όργανα οπότε γίνεται μια εν δυνάμει τύπου "ανακύκλωση" των πλαστικών αντικειμένων που έχει ως στόχο την επαναχρησιμοποίηση της ύλης, όπως συμβαίνει εξίσου και στο ηχητικό και το οπτικό μέρος του έργου. 

χρησιμοποιήθηκαν για τις ανάγκες αυτής της σύνθεσης μέσω της διαδικασίας της επιτέλεσης performance της παρτιτούρας. Επιπρόσθετα, κάθε φορά που εκτελείται η προαναφερθείσα παρτιτούρα γίνεται ανακύκλωση του υλικού της τόσο από την διαφοροποίηση του υλικού που χρησιμοποιήθηκε για την κάθε εκτέλεση όσο και από την κάθε εκτέλεση ξεχωριστά
...
31. Schubert, Alexander. “*Lecture ‘Virtuality and Post-Digitalism’ @ University Linz*” YouTube, Alexander Schubert, Published on 30 July 2020, https://www.youtube.com/watch?v=_9Mmt3TAJu8, Accessed on 22 Feb 2023.
32. Μεντίζης, Πασχάλης. “*Έμφραγμα Στην Ανακύκλωση Υλικών*”, Green Agenda, 2 Jan. 2020, https://greenagenda.gr/%CE%AD%CE%BC%CF%86%CF%81%CE%B1%CE%B3%CE%BC%CE%B1-%CF%83%CF%84%CE%B7%CE%BD-%CE%B1%CE%BD%CE%B1%CE%BA%CF%8D%CE%BA%CE%BB%CF%89%CF%83%CE%B7-%CF%85%CE%BB%CE%B9%CE%BA%CF%8E%CE%BD/, Accessed on 16 Apr 2023.
