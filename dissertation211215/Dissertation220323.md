...
Για να υποστηριχθεί η αφήγηση υπάρχουν αρκετές συνδέσεις μεταξύ του προκατασκευασμένου ηχητικού υλικού (tape) και του προκατασκευασμένου οπτικού υλικού (video). [Εξήγησε την προηγούμενη πρόταση με καλύτερη διατύπωση, και δώσε ένα παράδειγμα!] Αν και στα δύο μέσα έχει χρησιμοποιηθεί η τεχνική του κολλάζ για να συντεθούν προσπαθήσαμε μαζί με τον Ντουλματζή Κώστα να υπάρχει μία σχετική ισορροπία μεταξύ συνάφειας και μη [συνάφεια μεταξύ ποιών στοιχείων? Δώσε παραδείγματα!]. Αυτό έγινε με σκοπό τα μέσα να εκτυλίσσουν διαφορετικά την ιστορία και να συμπληρώνουν νοηματικά σε μερικά σημεία το ένα το άλλο και όχι να υπόκεινται το ένα στο άλλο σε μια σχέση άρρηκτης εξάρτησης. [Η λέξη κλειδί η οποία ήταν σαν συνθετική πρόθεση ήταν η αλληλεπίδραση μεταξύ των ξεχωριστών μέσων] [Δεν είναι κατανοητό αυτό. Παρκαλώ καλύτερη διατύπωση]. Επιπρόσθετα, λόγω του ο,τι το έργο έχει και επιτελεστικό πλαίσιο το οποίο αποτελείται από έναν έως 35 εκτελεστές, στο προκατασκευασμένο ηχητικό υλικό του έργου (tape) υπάρχουν κάποια ρυθμικά μοτίβα από την παρτιτούρα εκτέλεσης έτσι ώστε να προϊδεάζουν τόσο τους εκτελεστές όσο και το κοινό για την επικείμενη επιτέλεση (performance [δώσε παραδείγματα]). 

/////////////////////////////////// 

Στο έργο το πλαστικό αρχικά παρουσιάζεται ως υλικό το οποίο παράγεται και χρησιμοποιείται ευρέως από την ανθρωπότητα. Προς το τέλος του έργου στιαδιακά το πλαστικό σταματά να αντιμετωπίζεται σαν υλικό και αρχίζει να αντιμετωπίζεται σαν αφηρημένη έννοια, γίνεται δηλαδή μία μεταβολή από την κυριολεκτική στην μεταφορική αντιμετώπιση. [Την μεταφορά προσδίδει εξίσου το προκατακσευασμένο ηχητικό υλικό του έργου καθώς και το οπτικό.] [Δεν είναι κατανοητό. Εκφρασε το καλύτερα] Αυτό επιτυγχάνεται με την χρήση οπτικών δειγμάτων (video samples) που παρουσιάζουν τις εικόνες της Μπαρμπι (Barbie) και του συντόφου της Κεν (Ken) ως υπαρκτές περσόνες [εξήγησε γιατί αυτό δημιουργεί μεταφορά]. Το προκατασκευασμένο ηχητικό υλικό του έργου έρχεται να ενισχύσει το ερέθισμα της εικόνας και αυτό επιτυγχάνεται με την χρήση ηχητικών δειγμάτων (sound samples) από το ομώνυμο ποπ κομμάτι "*Barbie Girl*" του συγκροτήματος Άκουα. Σύμφωνα με τα παραπάνω συμπεραίνουμε ότι υπάρχουν συσχετίσεις/αλληλεξαρτήσεις και ρητορικά σχήματα εξίσου και στα τρία μέσα που αποτελούν το έργο (εικόνα, ήχος, επιτέλεση) καθόλη την διάρκεία του [δώσε παραδείγματα]. Οι συσχετίσεις αυτές μας δίνουν την αίσθηση της αλληλεπίδρασης μεταξύ των μέσων και είναι ο κοινός παρανομαστής για να έχουμε ένα επιτυχημένο πολυμεσικό έργο.

/////////////////////////////////

Στην συγκεκριμένη εκδοχή (version) του έργου συμμετέχουν ενεργά μόνο οι εκάστοτε επιτελεστές/σύνολο ενώ οι θεατές παρακολουθούν από κάποια απόσταση την επιτέλεση του έργου στο σύνολό της (εικόνα, ήχος, επιτέλεση). Θα λέγαμε με τους όρους τους αφήγησης πως η ιστορία εκτυλίσσεται σε ένα παροντικό χρόνο και οι θεατές είναι αμέτοχοι και μακριά από την εξέλιξη της υπόθεσης του έργου. Η αφηγηματική οπτική γωνία της επιτέλεσης στην συγκεκριμένη περίπτωση βρίσκεται σε πιο στεγανά μουσικά πρότυπα τα οποία είναι σύμφωνα με πιο αρχαϊκά συναυλιακά πρότυπα. [δηλαδή; τι εννοείς; δώσε παραδειγμα (;)] Το γεγονός αυτό δεν αναιρεί την πολυμεσικότητα, αλλά σαφώς στερείται της αμέσης αλληλεπίδρασης με το κοινό. Λόγω αυτού η εμπειρία ενός έργου με την παρούσα μορφή θα μπορούσε να χαρακτηριστεί εμβυθιστική (immersive) μόνο ως προς τον εαυτό της. Αυτό συμβαίνει διότι η παρτιτούρα του έργου είναι ανοικτής φόρμας και καλεί τους εκάστοτε επιτελεστές να συμμετέχουν ενεργά κατόπιν συγκεκριμένων οδηγιών. Οι επιτελεστές δεν επιτελούν μηχανικά το έργο μέσα από την παρτιτούρα αλλά κατόπιν των οδηγιών και της κρίσης τους είναι ελέυθεροι να παίρνουν αποφάσεις μέσα στο έργο αναφορικά με το πότε και εάν είναι σκόπιμο να παίξουν στα ρυθμικά μοτίβα της παρτιρούρας στα πλαστικά αντικείμενα.
...
Θα μπορούσε να υποστηριχθεί επιπλέον πως η συγκεκριμένη υπόθεση/θεματική εκτυλίσσεται από πολλαπλούς "αφηγητές" (διαφορετικά μέσα) τα οποία εκτυλίσσουν την αφήγηση από διαφορετικές οπτικές γωνίες και διαφορετικές χρονικές στιγμές. Μία τέτοια είδους αφήγηση δημιουργεί μια ιστορία με πολλές διαφορετικές προοπτικές/οπτικές γωνίες και συνεπώς εναπόκειται στον καθένα μας για το πως θα δομήσει αυτές τις διαφορετικές προοπτικές στην δική του πορεία αφήγησης. Στο συγκεκριμένο έργο θα μπορούσε να υποστηριχθεί πως εν μέρει συμβαίνει κάτι τέτοιο λόγω του ότι πρόκειται για ένα κολλάζ εκφάνσεων του πλαστικού στην ζωή μας τόσο από το προκατασμευένο ηχητικό υλικό του έργου (tape) όσο και από το οπτικό. [Δωσε παράδειγμα]. Ωστόσο, η αφήγηση δεν είναι τελείως ελεύθερη καθώς υπάρχει κλιμάκωση η οποία συνεργείται και απο τα τρία μέσα και οδηγεί την έννοια του πλαστικού από την κυριολεξία στην μεταφορά. Το κάθε μέσο με την διαφορετική οπτική γωνία που έχει λόγω της φύσης του έρχεται και εμπερικλείει την υπόθεση (concept) και οδηγεί σε ένα κοινό συμπέρασμα. 
