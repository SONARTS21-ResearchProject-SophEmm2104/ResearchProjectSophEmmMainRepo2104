...
Η έρευνα αυτή ξεκίνησε με στόχο να βρεθεί μία ακριβής μετάφραση του ήχου σε εικόνα και της εικόνας σε ήχο. Ανέκαθεν μου κέντριζε το ενδιαφέρον το φαινόμενο της συναισθησίας (synaesthesia), της νευρολογικής πάθησης όπου γίνεται συνδυασμός δύο ή παραπάνω αισθήσεων (Nelson, 2022). Συγκεκριμένα το φαινόμενο που θα ήθελα να μελετήσω είναι ένας τύπος συναισθησίας, η χρωματική συναισθησία (chromaesthesia and/or sound-to-color synesthesia) κατά την οποία μία οποιαδήποτε μη οπτική διαδικασία έχει ως αποτέλεσμα την διέγερση χρωματικών/οπτικών αισθήσεων (Nelson, 2022 · Neely, 2018).

//

Εάν και υπάρχει πλήθος ερευνών από τον 20ο και 21ο αιώνα από επιστήμονες που προσπαθούν να βρούνε μία φόρμουλα που να προσδίδει με αντικειμενικά κριτήρια την σχέση μεταξύ του ήχου και της εικόνας, κάτι τέτοιο δυστυχώς δεν είναι εφικτό.  ... δεν μπορεί να υπάρξει ακριβής μετάφραση του ήχου σε εικόνα και της εικόνας σε ήχουν η οποία επαληθεύεται με αντικειμενικά κριτήρια. Λόγω του ότι η εικόνα είναι.... και ο ήχος είναι.... δεν γίνεται (Neely,2018)
