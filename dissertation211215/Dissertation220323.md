...
υπάρχει αλληλεπίδρασή ή ρητορικά σχήματα που προσδίδουν σχέσεις αλληλεξάρτησης;
 ...
 Η έρευνα αυτή εξετάζει την υπόθεση ότι κάθε μέσο έχει διαφορετική οπτική γωνία που συνυφαίνεται με τις εγγενείς ιδιότητες του μέσου. Κατά συνέπεια στην εργασία αναλύονται σε βάθος οι σχέσεις αλληλεξάρτησης/αλληλεπίδρασης μεταξύ των μέσων στην αφήγηση.


Από τα παραπάνω προκύπτει πως η αφήγηση ιστοριών με πολυμέσα έχει πολλά οφέλη. Βασικό μεταξύ αυτών είναι η ικανότητα να προκαλεί ισχυρότερα συναισθήματα και να αιχμαλωτίζει την προσοχή του κοινού για μεγαλύτερα χρονικά διαστήματα. Για παράδειγμα, μια μορφή αφήγησης με πολυμέσα όπως το διαδραστικό ινφογκράφικ (infographic) είναι ιδιαίτερα αποτελεσματική στην προσέλκυση χρηστών, επειδή πρέπει να συμμετέχουν ενεργά στην ιστορία με διάδραση όπως κύλιση, κλικ και κύλιση πάνω στο περιεχόμενο για να έχουν την πλήρη "εμπειρία" (Sapega, 2022).   

Η αφήγηση στην πολυμεσικότητα στις τέχνες είναι πολύ σημαντική διότι εάν γνωρίζουμε τα δομικά στοιχεία που αποτελούν την ιστορία μας (μέσα) και αποκρυπτογραφήσουμε τους μηχανισμούς που την απαρτίζουν τότε είμαστε σε θέση να καταλάβουμε συνειδητά τους συνδυασμούς/σχετήσεις που μπορεί ένα μέσο να έχει με ένα άλλο. Κατ' αυτόν τον τρόπο ένας συνθέτης πολυμεσικών έργων έχει την δυνατότητα να δημιουργεί σύμφωνα με την βούλησή του τεχνητές συναισθητικές εμπειρίες ή ευρέως πολυμεσικών έργων.
...
## 3.7 Μεταβολή της αλληλεπίδρασης των μεσών στις διαφορετικές εκδοχές του έργου "*Life in Plastic*"
 ...
 4. Κατά πόσο μεταβάλλεται η αλληλεπίδραση των μεσών στις δύο διαφορετικές εκδοχές του έργου και πως;  
...
Συνοψίζοντας, η πολυμεσικότητα θα λέγαμε πως από μια 
...
Συνεργία των μέσων για το εκάστοτε τελικό αποτέλεσμα 

Τέχνη του σινεμά -> προσομοίωση εν δυνάμει της πραγματικής ζωής/εμπειρίας

Αντιλαμβανόμαστε τον κόσμο μέσω των αισθήσεών μας και λόγου αυτού προσπαθούμε τα εργαλεία που χρησιμοποιούμε να είναι όσο πιο ρεαλιστικά/πραγματικά γίνεται. Πργματικότητα μέσα στην πραγματικότητα

μία δράση οδηγεί σε μία ανάλογη αντίδραση -> διαδραστικότητα 
...
Το ερώτημα εάν υπάρχει άμεση σχέση μεταξύ ήχου και εικόνας έχει αποτυπωθεί από τις απαρχές του Ρομαντισμού τόσο από μουσικούς όσο και από άλλους μελετητές και λόγιους. Δυστυχώς δεν υπάρχει ακριβής μετάφραση από ήχο σε εικόνα και από εικόνα σε ήχο η οποία μπορεί να εξετασθεί με αντικειμενικούς όρους. Βέβαια, αυτό δεν εμποδίζει την έρευνα σαν έρευνα ούτε το καλλιτεχνικό έργο των συνθετών πολυμεσικών έργων. Αντ' αυτού πιστεύω πως οι προσπάθειες αυτές συσχέτισης και νοηματοδότισης μας οδηγούν σε νέα ερευνητικά ερωτήματα τα οποία μπορούνε ίσως να απαντηθούν από ερευνητές νερυψυχολογίας και ψυχοακουστικής. 
...
37. Ordway, Scott. “*Biography*” Scott Ordway, https://www.scottordway.com/biography, Accessed on 17 Apr 2023.
