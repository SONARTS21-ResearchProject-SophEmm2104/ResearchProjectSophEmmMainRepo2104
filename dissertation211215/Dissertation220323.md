...
# «Η αλλαγή της αλληλεπίδρασης μεταξύ του Ήχου και της Εικόνας στo έργo μου "Life in Plastic" και οι διαφορετικές προοπτικές αναφορικά με την εκτέλεση του έργου»
...
Η παρούσα διπλωματική εργασία ασχολείται με την ανάλυση του πολυμεσικού μου έργου (multimedia) “Life in Plastic”. Αντικείμενο μελέτης της αποτελεί η σχέση μεταξύ της εικόνας, του ήχου και της performance. Η μελέτη αυτή θα βασιστεί πάνω στην θεωρία της αφήγησης (narration) και την ρητορική. Θα εξεταστεί ιδιαίτερα η αφηγηματική θέση και ο αφηγηματικός χρόνος για το ήδη προκατασκευασμένο οπτικό (video) και ηχητικό (tape) μέρος του έργου. Επιπλέον, θα εξετασθούν οι διαφορετικές προοπτικές εκτέλεσης του έργου καθώς και πως αυτές μεταβάλλουν την συνολική δομή του έργου. Συγκεκριμένα θα εξετασθεί η διαφορετικότητα της αντίληψής μας αναφορικά με τον ήχο και την εικόνα σε δύο πιθανές εκτελεσεις (versions) του έργου "Life in Plastic".   

Η ανάλυση ενός έργου από τον ίδιο τον συνθέτη εάν και φαίνεται προβληματική, ο συνθέτης μπορεί να στηρίξει και να δικαιολογήσει την πρόθεσή του μέσω της θεωρίας της αφήγησης και να αντιστοιχίσει τα μέσα που επέλεξε και τον τρόπο χρήσης τους προς το επιδιωκόμενο αποτέλεσμα και να ανοίξει τον δρόμο ερευνητικά για να τεθούν νέα ερωτήματα σχετικά με την σχέση μεταξύ ήχου και εικόνας (Klangbild und Bildklang).

# Περίληψη στα αγγλικά (Abstract)

This thesis deals with the analysis of my multimedia project "Life in Plastic". The object of study is the relationship between image, sound and performance. This study will be based on the theory of narration and rhetoric. In particular, the narrative position and narrative time for the already prefabricated visual (video) and audio (tape) part of the work will be examined. In addition, the different perspectives of the performance of the work and how they alter the overall structure of the work will also be indicated. Furthermore, the differences in our perception of sound and image in two possible versions of the project "Life in Plastic" will be the focus on this thesis.   

Although the analysis of a work by the composer himself seems problematic, the composer can support and justify his intention through the theory of narrative and can relate the means he chose and the way he used them to the intended effect and open the way for research to raise new questions about the relationship between sound and image (Klangbild und Bildklang).
...
Η οπτική γωνία με την οποία εξετάζεται η διπλωματική αυτή είναι αυτή του συνθέτη/μουσικολόγου. Με την σύνταξη της παρούσας διπλωματικής εργασίας έχω σκοπό να αναδείξω τα τεχνικά μέσα τα οποία προσδίδουν σχέση αλληλεπίδρασης μεταξύ ήχου και εικόνας έτσι ώστε μελλοντικοί συνθέτες/μουσικολόγοι να έχουν την εφόδια να αναπτύξουν τα δικά τους πολυμεσικά έργα ή να αναλύσουν επαρκώς τα ήδη υπάρχοντα.  
